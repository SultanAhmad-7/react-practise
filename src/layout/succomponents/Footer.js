              ...
              <div class="card mb-4">
                  <div class="card-body">
                      ...
                      <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3">
                          <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="assets\images\products\headphone-4.jpeg" alt="" />
                      ...
                      <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3">
                          <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="assets\images\products\headphone-2.jpeg" alt="" />
                          <div class="flex-grow-1">
                      ...
                      <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3">
                          <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="assets\images\products\headphone-3.jpeg" alt="" />
                          <div class="flex-grow-1">
